...
<template>
  <div class="fixed left-0 top-0 p-6 h-full bg-dark2 z-50 w-full overflow-y-auto md:max-w-[480px] pb-6">
    ...
    <div v-if="!currentUser" class="flex items-center justify-center flex-col gap-4 text-white mt-20">
      ...
      <Button shape="squared" color="primary" @click="handleRedirectToLogin">Se connecter</Button>
    </div>
      ...
      <form @submit="handleShareConfig">
        <div>
          ...
          <div class="mt-3 text-center sm:mt-5">
            <DialogTitle as="h3" class="text-base font-semibold leading-6 text-white">Give this config a name !
            </DialogTitle>
            <div class="mt-10">
        ...
        <div class="mt-5 sm:mt-6 sm:grid sm:grid-flow-row-dense sm:grid-cols-2 sm:gap-3">
          ...
          <button type="button"
            ...
            @click="publishConfigModalOpen = false" ref="cancelButtonRef">
            Cancel
          </button>
        </div>
      </form>
